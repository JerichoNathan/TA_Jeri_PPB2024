...
export default function SearchScreen({ navigation }) {
  ...
  const handleSearch = async () => {
    ...
    return (
      <ImageBackground style={{flex:1}} source={{ uri: 'https://static.wikia.nocookie.net/mrfz/images/e/ef/Doctor_DM.png/revision/latest?cb=20200513130635'}}>
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start'}}>
            <View style={{
                marginTop: 40, marginHorizontal: 10, alignSelf: 'stretch', padding: 10,
                borderRadius: 20, backgroundColor: 'rgba(88, 120, 26, 0.7)',
                flexDirection: 'row',
                alignItems: 'center'
            }}>
                <TextInput
