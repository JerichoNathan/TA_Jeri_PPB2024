        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }} >
            <TouchableOpacity onPress={() => navigation.navigate('Search')}
                style={{ 
                    ...
                    borderRadius:20, backgroundColor: 'rgba(88, 120, 26, 0.2)',
                    flexDirection:'row',
                    alignItems:'center'
                }}>
            ...
            <ImageBackground source={{ uri: 'https://arknights.wiki.gg/images/d/d6/Home_Screen_background-Other_Side.png' }}
